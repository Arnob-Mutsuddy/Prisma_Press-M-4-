...
const getPostById= async(postId:string) =>{
    //Transaction And Rollback have to do , for to hendel if get error is somewhere or any error occur. the view count rollback into the privios state //

    // const updatedPostView = await prisma.post.update({
    //     where:{
    //         id:payload
    //     },
    //     data:{
